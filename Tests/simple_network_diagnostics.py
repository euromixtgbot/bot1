...
def test_dns_resolution():
    ...
    for domain in test_domains:
        try:
            ...
            results[domain] = {"status": "SUCCESS", "ip": ip, "error": None}
            logger.info(f"✅ {domain}: {ip}")
        except socket.gaierror as e:
            results[domain] = {"status": "DNS_FAILURE", "ip": None, "error": str(e)}
            logger.error(f"❌ {domain}: DNS Error - {e}")
        except Exception as e:
            results[domain] = {"status": "OTHER_ERROR", "ip": None, "error": str(e)}
...
def check_dns_configuration():
    ...
    try:
        ...
        results["resolv_conf"] = {"status": "ERROR", "error": str(e)}
    ...
    try:
        ...
        results["systemd_resolved"] = {"status": "ERROR", "error": str(e)}
...
def analyze_log_patterns():
    ...
    log_files = ["/home/Bot1/logs/bot.log", "/home/Bot1/logs/webhook.log"]
    ...
    for log_file in log_files:
        try:
            ...
            results[log_file] = {"status": "NOT_FOUND", "error": "Log file not found"}
            logger.warning(f"⚠️ Log file not found: {log_file}")
        except Exception as e:
            results[log_file] = {"status": "ERROR", "error": str(e)}
